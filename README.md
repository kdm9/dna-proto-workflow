...
You will need to configure the workflow for your specific project. For details see the [technical documentation](https://dna-proto-workflow-master.readthedocs.io/en/latest/). Below files and directories will need editing:
